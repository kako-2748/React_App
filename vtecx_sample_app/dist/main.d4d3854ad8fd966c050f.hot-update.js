...
var CheckComponent = function () {
    var _a = react_1.useContext(FormContext), gender = _a[0], state = _a[1];
    var _b = react_1.useContext(ChangeTextContext), setSelectBox = _b[0], setGender = _b[1], dispatch = _b[2];
    console.log(state);
...
var App = function () {
    ...
    return (React.createElement("div", null,
        React.createElement(FormContext.Provider, { value: [name, email, memo, gender, address, job, height, selectBox, birthday, state] },
...
//# sourceMappingURL=main.d4d3854ad8fd966c050f.hot-update.js.map