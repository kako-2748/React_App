...
var ChangeTextContext = react_1.createContext([function (e) { return (e.target.value); }]);
var initState = { check: 'チェックなし' };
var reducer = function (state, action) {
    switch (action.type) {
        case 'check1':
            return __assign({}, state, { check: 'チェック1' });
        case 'check2':
            return __assign({}, state, { check: 'チェック2' });
        case 'check3':
            return __assign({}, state, { check: 'チェック3' });
        default:
            return state;
    }
};
...
var CheckComponent = function () {
    ...
    var _a = react_1.useContext(ChangeTextContext), setSelectBox = _a[0], setGender = _a[1];
    var _b = react_1.useReducer(reducer, initState), state = _b[0], dispatch = _b[1];
    console.log(state);
    ...
    return (React.createElement("div", null,
        React.createElement(FormContext.Provider, { value: [name, email, memo, gender, address, job, height, selectBox, birthday] },
            React.createElement(ChangeTextContext.Provider, { value: [setName, setEmail, setJob, setAddress,
                    setMemo, setHeight, setGender, putdata, setSelectBox, dispatch, setBirthday] },
...
//# sourceMappingURL=main.a40a442274374542146e.hot-update.js.map