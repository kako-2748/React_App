...
var CheckComponent = function () {
    ...
    var _a = react_1.useContext(ChangeTextContext), setSelectBox = _a[0], setGender = _a[1], state = _a[2], dispatch = _a[3];
    console.log(state);
    ...
    return (React.createElement("div", null,
        React.createElement(FormContext.Provider, { value: [name, email, memo, gender, address, job, height, selectBox, birthday] },
            React.createElement(ChangeTextContext.Provider, { value: [setName, setEmail, setJob, setAddress,
                    setMemo, setHeight, setGender, putdata, setSelectBox, setBirthday, state, dispatch] },
...
//# sourceMappingURL=main.2c046301a9efddd7f30e.hot-update.js.map