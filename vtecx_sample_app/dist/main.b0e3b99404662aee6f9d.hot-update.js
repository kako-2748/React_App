...
var FormComponent = function () {
    ...
    return (React.createElement("form", { name: "forms" },
        ...
        React.createElement("br", null),
        React.createElement("input", { type: "date", name: "calendar", max: "9999-12-31", onChange: function (e) { return setBirthday(e.target.value); } }),
        React.createElement("br", null),
        React.createElement("input", { type: "text", name: job, onChange: function (e) { return setJob(e.target.value); }, placeholder: "\u8077\u696D" }),
        React.createElement("br", null),
...
var CheckComponent = function () {
    var _a = react_1.useContext(FormContext), gender = _a[0], check = _a[1];
    var _b = react_1.useContext(ChangeTextContext), setSelectBox = _b[0], setGender = _b[1], setCheck = _b[2];
    return (React.createElement("form", null,
        ...
        React.createElement("br", null),
        React.createElement("input", { type: "checkbox", name: check, value: "check1", onChange: function () { return setCheck('チェック１'); } }),
        "\u30C1\u30A7\u30C3\u30AF\uFF11",
        React.createElement("input", { type: "checkbox", name: check, value: "check2", onChange: function () { return setCheck('チェック２'); } }),
        "\u30C1\u30A7\u30C3\u30AF2",
        React.createElement("input", { type: "checkbox", name: check, value: "check3", onChange: function () { return setCheck('チェック３'); } }),
        "\u30C1\u30A7\u30C3\u30AF3",
        React.createElement("br", null),
...
var App = function () {
    ...
    var _k = react_1.useState(''), check = _k[0], setCheck = _k[1];
    console.log(birthday);
    var req = [
        {
            user: {
    ...
    return (React.createElement("div", null,
        React.createElement(FormContext.Provider, { value: [name, email, memo, gender, address, job, height, selectBox, birthday, check] },
            React.createElement(ChangeTextContext.Provider, { value: [setName, setEmail, setJob, setAddress,
                    setMemo, setHeight, setGender, putdata, setSelectBox, setBirthday, setCheck] },
...
//# sourceMappingURL=main.b0e3b99404662aee6f9d.hot-update.js.map