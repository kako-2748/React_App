...
var CheckComponent = function () {
    ...
    return (React.createElement("form", null,
        ...
        React.createElement("br", null),
        React.createElement("input", { type: "checkbox", name: state.check, onChange: function () { return setState(__assign({}, state, state.check, { check: 'チェック１' })); } }),
        "\u30C1\u30A7\u30C3\u30AF\uFF11",
        React.createElement("input", { type: "checkbox", name: state.check, onChange: function () { return setState(__assign({}, state, state.check, { check: 'チェック２' })); } }),
        "\u30C1\u30A7\u30C3\u30AF2",
        React.createElement("input", { type: "checkbox", name: state.check, onChange: function () { return setState(__assign({}, state, state.check, { check: 'チェック３' })); } }),
        "\u30C1\u30A7\u30C3\u30AF3",
        React.createElement("br", null),
...
//# sourceMappingURL=main.2e826bce09ea301ce5ce.hot-update.js.map