...
var FormComponent = function () {
    var _a = react_1.useContext(FormContext), name = _a[0], email = _a[1], memo = _a[2], address = _a[3], job = _a[4], height = _a[5], birthday = _a[6], setName = _a[7], setEmail = _a[8], setJob = _a[9], setAddress = _a[10], setMemo = _a[11], setHeight = _a[12], setBirthday = _a[13];
...
var CheckComponent = function () {
    var _a = react_1.useContext(FormContext), gender = _a[0], setSelectBox = _a[1], setGender = _a[2], dispatch = _a[3];
...
var App = function () {
    ...
    return (React.createElement("div", null,
        React.createElement(FormContext.Provider, { value: [name, email, memo, gender, address, job, height, selectBox, birthday, setName, setEmail, setJob, setAddress,
...
//# sourceMappingURL=main.84da93febc3489ad991b.hot-update.js.map