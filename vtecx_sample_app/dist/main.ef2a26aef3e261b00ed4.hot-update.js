...
var FormComponent = function () {
    ...
    var _b = react_1.useContext(ChangeTextContext), setName = _b[0], setEmail = _b[1], setJob = _b[2], setAddress = _b[3], setMemo = _b[4], setHeight = _b[5];
    console.log(name);
    console.log(email);
    console.log(memo);
    console.log(address);
    ...
    return (React.createElement("form", { name: "forms" },
        ...
        React.createElement("br", null),
        React.createElement("input", { type: "text", name: job, value: job, onChange: function (e) { return setJob(e.target.value); }, placeholder: "\u8077\u696D" }),
        React.createElement("br", null),
        ...
        React.createElement("input", { type: "number", name: height, value: height, onChange: function (e) { return setHeight(e.target.value); } }),
        React.createElement("br", null),
...
var CheckComponent = function () {
    ...
    return (React.createElement("form", null,
        React.createElement("input", { type: "radio", name: gender, onChange: function () { return setGender('男'); }, checked: gender === '男' }),
        React.createElement("label", { htmlFor: "gender" }, "\u7537"),
        React.createElement("input", { type: "radio", name: gender, onChange: function () { return setGender('女'); }, checked: gender === '女' }),
...
var App = function () {
    ...
    var _j = react_1.useReducer(reducer, initState), state = _j[0], dispatch = _j[1];
    var req = [
        {
            user: {
                name: name,
    ...
    return (React.createElement("div", null,
        React.createElement(FormContext.Provider, { value: [name, email, memo, gender, address, job, height, selectBox] },
            React.createElement(ChangeTextContext.Provider, { value: [setName, setEmail, setJob, setAddress,
                    setMemo, setHeight, setGender, putdata, setSelectBox, dispatch] },
...
//# sourceMappingURL=main.ef2a26aef3e261b00ed4.hot-update.js.map