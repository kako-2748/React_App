...
var FormComponent = function () {
    ...
    var _b = react_1.useContext(ChangeTextContext), changeName = _b[0], changeEmail = _b[1], changeJob = _b[2], changeAddress = _b[3], changeMemo = _b[4], changeHeight = _b[5];
    var _c = react_1.useContext(CheckedContext), checkedMen = _c[0], checkedWomen = _c[1];
    return (React.createElement("form", null,
        ...
        React.createElement("input", { type: "submit", value: "\u767B\u9332" })));
};
...
var App = function () {
    ...
    return (React.createElement("div", null,
        React.createElement(FormContext.Provider, { value: [name, email, memo, gender, address, job, height] },
            React.createElement(ChangeTextContext.Provider, { value: [changeName, changeEmail, changeJob, changeAddress, changeMemo, changeHeight] },
                React.createElement(CheckedContext.Provider, { value: [checkedMen, checkedWomen] },
...
//# sourceMappingURL=main.bf7442387d13230708f7.hot-update.js.map