...
var CheckComponent = function () {
    ...
    return (React.createElement("form", null,
        React.createElement("input", { type: "radio", name: state.gender, onChange: function () { return setState('男'); } }),
        React.createElement("label", { htmlFor: "gender" }, "\u7537"),
        React.createElement("input", { type: "radio", name: state.gender, onChange: function () { return setState('女'); } }),
        React.createElement("label", { htmlFor: "gender" }, "\u5973"),
        React.createElement("br", null),
        React.createElement("input", { type: "checkbox", name: state.check, onChange: function () { return setState('チェック１'); } }),
        "\u30C1\u30A7\u30C3\u30AF\uFF11",
        React.createElement("input", { type: "checkbox", name: state.check, onChange: function () { return setState('チェック２'); } }),
        "\u30C1\u30A7\u30C3\u30AF2",
        React.createElement("input", { type: "checkbox", name: state.check, onChange: function () { return setState('チェック３'); } }),
        "\u30C1\u30A7\u30C3\u30AF3",
        React.createElement("br", null),
        React.createElement("select", { name: "example", id: "output", onChange: function (select) { return setState(select.value); } },
...
//# sourceMappingURL=main.428480b5cd489f86a596.hot-update.js.map