...
var reducer = function (state, action) {
    switch (action.type) {
        case 'check1':
            return __assign({}, state, { check: __assign({}, state.check) + 'チェック1' });
        case 'check2':
...
var App = function () {
    ...
    var state = react_1.useReducer(reducer, initState)[0];
    console.log(birthday);
    var req = [
        {
            user: {
    ...
    return (React.createElement("div", null,
        React.createElement(FormContext.Provider, { value: [name, email, memo, gender, address, job, height, selectBox, birthday] },
            React.createElement(ChangeTextContext.Provider, { value: [setName, setEmail, setJob, setAddress,
                    setMemo, setHeight, setGender, putdata, setSelectBox, setBirthday] },
...
//# sourceMappingURL=main.2ab9edeea8bf9e6a9c3b.hot-update.js.map